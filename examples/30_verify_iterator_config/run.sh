...
main() {
  ...
  local initial_prompt="${AGENT_DIR}/prompts/steps/initial/task/f_default.md"
  if [[ ! -f "$initial_prompt" ]]; then
    error "FAIL: initial/task/f_default.md not found"; return 1
  fi
  success "PASS: initial/task/f_default.md exists"

  local closure_prompt="${AGENT_DIR}/prompts/steps/closure/task/f_default.md"
  if [[ ! -f "$closure_prompt" ]]; then
    error "FAIL: closure/task/f_default.md not found"; return 1
  fi
  success "PASS: closure/task/f_default.md exists"
