...
The `description` should include both what the Skill does and when Claude should use it. For complete authoring guidance, see the [best practices guide](best-practices.md).
...
These Skills are available on the Claude API and claude.ai. See the [quickstart tutorial](quickstart.md) to start using them in the API.
...
- [Authoring best practices](best-practices.md) - Write Skills that Claude can use effectively
