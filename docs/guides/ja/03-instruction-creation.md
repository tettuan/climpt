...
指示書は、AI に対する指示を定義したマークダウンファイルです。
C3L（Climpt 3-word Language）仕様に従って、3つの要素で構成されます：
...
[04-iterate-agent-setup.md](./04-iterate-agent-setup.md) へ進んで、Iterate Agent を設定します。
