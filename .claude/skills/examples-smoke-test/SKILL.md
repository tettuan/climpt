...
具体的な手順は [smoke-test-execution.md](./references/smoke-test-execution.md) を参照。
...
症状と原因の詳細な対応表は [troubleshooting-matrix.md](./references/troubleshooting-matrix.md) を参照。
...
環境別の注意点は [environment-notes.md](./references/environment-notes.md) を参照。
