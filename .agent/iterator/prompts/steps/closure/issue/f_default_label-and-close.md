...
name: Issue Closure Prompt (Label and Close)
description: Terminal step for issue completion - labels then closes
uvVariables:
  - issue_number
customVariables:
  - summary_section
...
# Issue Closure: Issue #{uv-issue_number} (Label and Close)
...
2. Tests pass
3. Labels are updated and the issue is closed
