...
| 7 | [07_flow_design.md](./07_flow_design.md)                         | Flow 設計ガイド         | role 選択・cycle 意味論・flow pattern を理解したいとき |
| 8 | [08_github_integration.md](./08_github_integration.md)           | GitHub 連携ガイド       | GitHub 操作の全体像を知りたいとき                      |
| 9 | [09_closure_output_contract.md](./09_closure_output_contract.md) | Closure Output Contract | closure step の出力契約・verdict emit を把握したいとき |
