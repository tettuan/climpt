...
[08_closure_output_contract.md](./08_closure_output_contract.md) を参照。
...
| `defaultClosureAction`     | string   | closure 時の動作。詳細は [08_closure_output_contract.md](./08_closure_output_contract.md) 参照                                                     |
