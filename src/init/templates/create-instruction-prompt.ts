/**
 * @fileoverview Create Instruction prompt template for meta domain
 * @module init/templates/create-instruction-prompt
 */

/**
 * Prompt template for creating new Climpt instructions
 */
export const CREATE_INSTRUCTION_PROMPT = `---
c1: meta
c2: create
c3: instruction
