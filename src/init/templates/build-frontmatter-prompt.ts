/**
 * @fileoverview Build Frontmatter prompt template for meta domain
 * @module init/templates/build-frontmatter-prompt
 */

/**
 * Prompt template for building C3L compliant frontmatter
 */
export const BUILD_FRONTMATTER_PROMPT = `---
c1: meta
c2: build
c3: frontmatter
